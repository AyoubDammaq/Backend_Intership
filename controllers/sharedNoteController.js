...
module.exports.addSharedNote = async (req, res) => {
...
module.exports.getSharedNoteById = async (req, res) => {
    const _id = req.params.id;

    sql = 'SELECT * FROM sharednote WHERE idSender = ?';
...
module.exports.updateSharedNote = async (req, res) => {
    const _id = req.params.id;
...
module.exports.removeSharedNote = async (req, res) => {
    const _id = req.params.id;
